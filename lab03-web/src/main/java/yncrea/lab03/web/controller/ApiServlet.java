package yncrea.lab03.web.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;
import yncrea.lab03.core.service.BusinessTypeService;
import yncrea.lab03.core.service.CompanyService;
import yncrea.lab03.core.service.CustomerService;
import yncrea.lab03.core.service.ProjectService;
...
public class ApiServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        final AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext("yncrea.lab03.core.config");
